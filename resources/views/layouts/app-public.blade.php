...
<head>
    ...
    <meta name="description" content="The best tumbler with an elegan touching">
    <meta name="keywords" content="ecommerce, tumbler">
    <meta name="author" content="YobelKimtoputra-422023001">

    <title>@yield('title') | YobelKimtoputra-422023001</title>
...
<body class="box-home">
    ...
    <script src="{{ asset('assets/js/plugins/TVplayer.js') }}"></script>
    <!-- Instagramfeed JS -->
