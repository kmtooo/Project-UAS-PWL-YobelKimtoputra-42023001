...
function getData(){
    ...
    .then(function (response) {
        ...
        (response.data.products).forEach((item) => {
            template += `
            <div class="single-hero-slider-7" onclick="location.href='`+baseUrl+`/tumbler/`+item.id+`'">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-content-wrap">
                                <div class="hero-text-7 mt-lg-5">
                                    ...
                                    <h1>`+breakWord(item.tumbler_name)+`</h1>
                                ...
                                <div class="inner-images">
                                    <div class="image-one">
                                        <img src="`+item.pict+`" width="250" class="img-fluid" alt="Image">
                                    </div>
                                </div>
                            </div>
                        </div>
